...
export function Button({
  ...
  const sizeClasses = size === "sm" ? "h-9 px-3 text-xs gap-1.5" : "h-10 px-4 text-sm gap-2";
  ...
  switch (variant) {
    ...
    case "secondary":
      ...
      break;
    case "danger":
      variantClasses = "bg-paper text-danger border border-danger hover:bg-danger-tint";
      break;
    case "ghost":
      variantClasses = "bg-transparent text-graphite hover:text-ink hover:bg-hover";
      break;
  }
